...
Status transitions can optionally trigger external notifications. If `$NB_WORKSPACES_ROOT/.hooks.md` exists, sub-commands read it for hook configuration:
