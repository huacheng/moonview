...
- **Collection Direction**: Skill design patterns, the agent plugin API, prompt engineering techniques
- **Key Sources**: the agent docs, skill-creator guidelines, MCP spec, prompt engineering papers
...
- **Key Sources**: the agent API testing, prompt evaluation tools, A/B testing frameworks
...
- **Key Sources**: the agent skill guidelines, UX heuristics for conversational AI
...
- **Collection Direction**: the agent API reference, MCP protocol spec, prompt engineering patterns
